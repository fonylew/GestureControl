...
//    	if(cv::waitKey(30) == char('a')) press(0xAF); //volume UP
//    	if(cv::waitKey(30) == char('s')) press(0xAE); //volume DOWN
//    	if(cv::waitKey(30) == char('d')) press(0xAD); //volume MUTE/UNMUTE
//    	if(cv::waitKey(30) == char('f')) press(0xB3); //PLAY/PAUSE
//    	if(cv::waitKey(30) == char('g')) press(0xA9); //STOP
//    	if(cv::waitKey(30) == char('h')) press(0xB1); //PREVIOUS
//    	if(cv::waitKey(30) == char('j')) press(0xB0); //NEXT
	}
	destroyAllWindows();
	out.release();
	m.cap.release();
